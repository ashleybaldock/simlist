...
var db = new mongodb.Db('nodejitsu_tbentropy_nodejitsudb929723982',
  new mongodb.Server('ds027718.mongolab.com', 27718, {})
);
db.open(function (err, db_p) {
  if (err) { throw err; }
  db.authenticate('nodejitsu_tbentropy', 'd4mt7tpnarcrkoj13s31qfdmff', function (err, replies) {
